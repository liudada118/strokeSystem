...
export default function Card(props: any) {
  ...
  return (
    <div className={`md:w-[94%] md:mx-auto bg-[#fff] ${isMobile ? 'py-[1.4rem]' : 'py-[3.4rem]'} flex flex-col px-[1.1rem] w-full rounded-[10px] ${unheight ? '' : ' h-full'} ${props.margin ? '' : 'mb-[10px]'} ${mdmb ? 'md:mb-[0.8rem] ' : ''}`} >
