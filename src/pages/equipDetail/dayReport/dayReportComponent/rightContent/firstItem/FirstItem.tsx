...
export const positionArr = [15, 10, 35, 20]
                        ...
                        <div className="nurseContent nurseChartsContent nurseHeartCharts firstCharts">
                            ...
                            <div className="daySleepInfo">
                                <div className="daySleepItem">
                                    ...
                                    <CapZeroUtil value={props.data.breathrate ? Math.max(...rateArrToHeart(oriRateToRate(props.data.breathrate))) : 0} util='bpm' />
                                ...
                                <div className="daySleepItem">
                                    ...
                                    <CapZeroUtil value={props.data.breathrate ? calMin(rateArrToHeart(oriRateToRate(props.data.breathrate))) : 0} util='bpm' />
