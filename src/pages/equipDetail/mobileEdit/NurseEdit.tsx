...
const nurseItem = [{ text: '上传照片', type: ConfigType.IMG }, { text: '输入', type: ConfigType.INPUT }]
const nurseItemIncludeChild = [{ text: '单选', type: ConfigType.SINGLE }, { text: '多选', type: ConfigType.MULE }]
    ...
    return (
        ...
        <div className='pt-[13px] px-[15px]'>
            <div className='relative flex items-center justify-center mb-[20px]'>
                ...
                </div> <div className='text-center text-lg font-bold'>{nurseItemIncludeChild[index].text}</div>
            </div>
            <div className='ml-[6px] text-base mb-[12px]'>{nurseItemIncludeChild[index].text}</div>
            <div>
                {
                            ...
                            <div className='flex items-center mb-[12px]' key={item.id}>
                                ...
                                <div className='w-full relative flex items-center'>
                                    <input
                                        ...
                                        className='bg-[#F5F8FA] w-full text-base py-[8px] rounded-[10px] pl-[20px] ' type="text" placeholder={`输入${nurseItemIncludeChild[index].text}选项`} />
                                    <div onClick={() => {
                                        itemRemove(itemIndex)
                                    }} className='absolute right-[10px]'><img src={nurseItemDelete} alt="" /></div>
                                </div>
