...
export default function Setting() {
  ...
  const showDrawer = () => {
    ...
    localStorage.removeItem('realtimeLeaveBedParam')
    localStorage.removeItem('sleepTypenur')
        ...
        {isMobile ? <div className='setBox'>
          ...
          <div className='setBoxPc'>
            <div className="selectBox">
              ...
              {
                localStorage.getItem('phone') === 'JQadmin' ? <p className='w-[244px] h-[41px] mt-2'>版本号 2.0 15</p> : ""
              }
            </div>
